...
import unisaLogo from "/photos/unisa-logo.png";
import marryatvilleLogo from "/photos/marryatville-logo.jpg";
            ...
            {educations.map((entry) => {
                ...
                return (
                    <div
                        ...
                        className={`rounded-md w-full py-6 px-10 bg-border-sub-light border  border-border-main duration-100 hover:cursor-pointer ${
                            isOpen
